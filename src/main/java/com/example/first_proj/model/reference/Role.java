...
public class Role {
    ...
    public List<Physician> getPhysiciansInRole() {
        return physiciansInRole;
    }

    public void setPhysiciansInRole(List<Physician> physiciansInRole) {
        this.physiciansInRole = physiciansInRole;
    }
}
